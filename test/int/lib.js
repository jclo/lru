...
module.exports = function(LRU, libname, version) {
  describe('LRU introspection:', () => {
    describe('Test the nature of LRU:', () => {
      ...
      it('Expects LRU to own 4 custom properties.', () => {
        expect(Object.keys(LRU)).to.be.an('array').that.has.lengthOf(4);
      });
    ...
    describe('Test LRU constructor:', () => {
      ...
      it('Expects LRU object to own 2 properties.', () => {
        expect(op).to.be.an('array').that.has.lengthOf(2);
      });

      it('Expects LRU object to inherit 10 properties.', () => {
